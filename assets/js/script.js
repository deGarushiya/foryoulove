...
// Debug: Log albumsData to verify it's loaded correctly
console.log('[DEBUG] albumsData loaded:', Object.keys(albumsData).length, 'albums');
Object.keys(albumsData).forEach(album => {
    console.log('[DEBUG]', album, 'has', albumsData[album].length, 'images');
});
